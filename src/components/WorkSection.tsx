    ...
    return (
        <div className="p-10" id="project-section">
            ...
            <ul className="p-0 m-0 mt-10 text-left list-none rounded-lg sm:shadow-xl sm:p-10 sm:bg-white sm:bg-opacity-70">
                <li className="bg-white bg-opacity-80 sm:bg-opacity-0 rounded-xl p-8 sm:p-0 m-0 min-w-[250px] max-w-[600px]">
                ...
                <li className="bg-white bg-opacity-80 sm:bg-opacity-0 rounded-xl p-8 sm:p-0 m-0 mt-20 ml-auto min-w-[250px] max-w-[600px]">
                ...
                <li className="bg-white bg-opacity-80 sm:bg-opacity-0 rounded-xl p-8 sm:p-0 m-0 mt-20 min-w-[250px] max-w-[600px]">
